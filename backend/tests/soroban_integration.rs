...
async fn test_soroban_client_creation() {
    ...
    assert_eq!(router_address, "CAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
async fn test_integration_service_with_signing() {
    ...
    let signing_config = bitcoin_custody_backend::services::soroban_client::SigningConfig {
